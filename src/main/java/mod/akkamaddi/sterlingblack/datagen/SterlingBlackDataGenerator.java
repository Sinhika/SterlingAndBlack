    ...
    public static void gatherData(GatherDataEvent event)
    {
        ...
        gen.addProvider(event.includeServer(), 
        	new SimpleLootTableProvider(packOutput, List.of(
    			new LootTableProvider.SubProviderEntry(SterlingBlackLootTableSubprovider::new, LootContextParamSets.BLOCK),
        		new LootTableProvider.SubProviderEntry( SterlingBlackLootInjectorSubprovider::new, LootContextParamSets.CHEST)
            )));
     } // end gatherData()
